...
from shioaji.watchlist import Watchlist
...
class Shioaji:
    ...
    def account_balance(
        ...
        """
        if account:
            return self._solace.account_balance(account, timeout=timeout, cb=cb)
        else:
            if self.stock_account:
    ...
    def fetch_watchlists(
        self,
        timeout: int = 5000,
        cb: typing.Callable[[typing.List[Watchlist]], None] = None,
    ) -> typing.List[Watchlist]:
        ...
        Returns:
            List[Watchlist]: list of watchlists
        """
        return self._solace.fetch_watchlists(timeout=timeout, cb=cb)

    def get_watchlist(
        self,
        group_id: str,
        timeout: int = 5000,
        cb: typing.Callable[[Watchlist], None] = None,
    ) -> Watchlist:
        """Get a specific watchlist by ID

        Args:
            group_id (str): the watchlist ID
            timeout (int): request timeout in milliseconds
            cb (Callable): callback function for async mode
        ...
        """
        return self._solace.get_watchlist(group_id, timeout=timeout, cb=cb)

    def create_watchlist(
        self,
        name: str,
        contracts: typing.List[Contract] = None,
        timeout: int = 5000,
        cb: typing.Callable[[Watchlist], None] = None,
    ) -> Watchlist:
        ...
        Args:
            ...
            contracts (List[Contract]): list of contracts to add (optional)
            timeout (int): request timeout in milliseconds
            cb (Callable): callback function for async mode

        Returns:
            Watchlist: the created watchlist
        """
        return self._solace.create_watchlist(
            name, contracts=contracts, timeout=timeout, cb=cb
        )
    ...
    def delete_watchlist(
        ...
        Returns:
            Watchlist: the deleted watchlist
        """
        return self._solace.delete_watchlist(group_id, timeout=timeout, cb=cb)
    ...
    def sync_watchlist(
        ...
        Args:
            group_id (str): the watchlist ID
            contracts (List[Contract]): list of contracts to sync
            timeout (int): request timeout in milliseconds
            cb (Callable): callback function for async mode
        ...
        """
        return self._solace.sync_watchlist(
            group_id, contracts, timeout=timeout, cb=cb
        )

    def watchlist_add_contract(
        self,
        group_id: str,
        contracts: typing.List[Contract],
        timeout: int = 5000,
        ...
        Args:
            group_id (str): the watchlist ID
            contracts (List[Contract]): list of contracts to add
            timeout (int): request timeout in milliseconds
            cb (Callable): callback function for async mode
        ...
        Returns:
            Watchlist: the updated watchlist
        """
        return self._solace.watchlist_add_contract(
            group_id, contracts, timeout=timeout, cb=cb
        )

    def watchlist_delete_contract(
        self,
        group_id: str,
        contracts: typing.List[Contract],
        timeout: int = 5000,
        ...
        Args:
            group_id (str): the watchlist ID
            contracts (List[Contract]): list of contracts to remove
            timeout (int): request timeout in milliseconds
            cb (Callable): callback function for async mode
        ...
        Returns:
            Watchlist: the updated watchlist
        """
        return self._solace.watchlist_delete_contract(
            group_id, contracts, timeout=timeout, cb=cb
        )
